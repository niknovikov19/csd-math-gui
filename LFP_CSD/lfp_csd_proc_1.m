function lfp_csd_proc_1(params, is_first_call)
...
A_vec_lin = max(0, A_c + yy * A_k);
A_vec_norm = normpdf(yy, A_mu, A_sigma);
A_vec = A_s * A_vec_lin + (1 - A_s) * A_vec_norm;

% LFP phase profile
phi_vec_lin = phi_c + yy * phi_k;
phi_vec_norm = normpdf(yy, phi_mu, phi_sigma);
phi_vec = phi_s * phi_vec_lin + (1 - phi_s) * phi_vec_norm;
